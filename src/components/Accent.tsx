  ...
  return (
    <span
      className={clsxm(
        ...
        'bg-gradient-to-tr from-primary-500 via-yellow-700 to-sky-600 bg-clip-text text-transparent dark:from-primary-300 dark:via-primary-100/70 dark:to-sky-300',
        className
      )}
    >
      {children}
